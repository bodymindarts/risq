...
lazy_static! {
    pub static ref ALL: Vec<Market> = {
        ...
        vec.push(new_market!("BLK-BURNT", "BTC"));
        ...
        vec.push(new_market!("D4RK", "BTC"));
        vec.push(new_market!("DCR", "BTC"));
        vec.push(new_market!("DOGE", "BTC"));
        vec.push(new_market!("DONU", "BTC"));
        ...
        vec.push(new_market!("EMC", "BTC"));
        vec.push(new_market!("ERG", "BTC"));
        ...
        vec.push(new_market!("KORE", "BTC"));
        vec.push(new_market!("KYDC", "BTC"));
        vec.push(new_market!("LBC", "BTC"));
        ...
        vec.push(new_market!("NTBC", "BTC"));
        vec.push(new_market!("ONION", "BTC"));
        vec.push(new_market!("PARS", "BTC"));
        vec.push(new_market!("PART", "BTC"));
        vec.push(new_market!("PENG", "BTC"));
        ...
        vec.push(new_market!("USDH", "BTC"));
        vec.push(new_market!("UPX", "BTC"));
        vec.push(new_market!("VARIUS", "BTC"));
        vec.push(new_market!("VEIL", "BTC"));
        vec.push(new_market!("VTC", "BTC"));
        vec.push(new_market!("VXV", "BTC"));
        vec.push(new_market!("WEB", "BTC"));
        vec.push(new_market!("WRKZ", "BTC"));
        vec.push(new_market!("WORX", "BTC"));
        vec.push(new_market!("XCP", "BTC"));
        vec.push(new_market!("XDR0", "BTC"));
        vec.push(new_market!("XND", "BTC"));
